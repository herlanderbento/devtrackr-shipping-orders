using App.DevTrackR.ShippingOrders.Core.Enums;
using App.DevTrackR.ShippingOrders.Core.ValueObjects;

namespace App.DevTrackR.ShippingOrders.Core.Entities
{
    public class ShippingOrder : EntityBase
    {
        public ShippingOrder(string description, decimal weightInKg, DeliveryAddress deliveryAddress) : base()
        {
